...
namespace LINQ_Test
{
    ...
    class MaxUnitInStockComparer : IComparer<Product>
    {
    ...
    class Product : IComparable<Product>
    {
        ...
        {
            return this.ProductID.GetHashCode()^this.ProductName.GetHashCode()^this.Category.GetHashCode()
                ^this.UnitsInStock.GetHashCode()^this.UnitPrice.GetHashCode();
        }
        public override bool Equals(object? obj)
        {
            ...
            return this.ProductID.Equals(other.ProductID)&&this.ProductName.Equals(other.ProductName)
                    &&this.UnitPrice.Equals(other.UnitPrice)&& this.UnitsInStock.Equals(other.UnitsInStock)
